    ...
    <section className="section-pad border-t border-subtle bg-surface" aria-labelledby="home-services-heading">
      <Container>
        ...
        <ul className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <li key={s.slug}>
              <article className="card flex h-full flex-col p-8 transition hover:border-[var(--rasta-green)]/30 motion-reduce:transition-none">
                ...
                <Link
                  ...
                  className="link-accent mt-6 inline-flex min-h-11 items-center text-sm font-semibold outline-none focus-visible:ring-2 focus-visible:ring-[var(--rasta-gold)] focus-visible:ring-offset-2"
                >
